...
def model_prediction(test_image):
    model = tf.keras.models.load_model(r"C:\final-project\trained_plant_disease_model.h5")
...
#Prediction Page
    ...
    if(st.button("Predict")):
        ...
        class_name = ['Apple Apple_scab', 'Apple Black_rot', 'Apple Cedar_apple_rust', 'Apple healthy',
                    ...
                    'Corn (maize) Common_rust_', 'Corn_(maize) Northern_Leaf_Blight', 'Corn_(maize) healthy', 
                    'Grape Black_rot', 'Grape Esca_(Black_Measles)', 'Grape Leaf_blight_(Isariopsis_Leaf_Spot)', 
                    'Grape healthy', 'Orange Haunglongbing (Citrus_greening)', 'Peach Bacterial_spot',
